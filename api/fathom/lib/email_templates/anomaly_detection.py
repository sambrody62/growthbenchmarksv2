...
def generate_anomaly_bullets(anomaly):
    ...
    account_link=f"https://growthbenchmarks.com/{long_provider}/{anomaly['account_id']}/{metric}"
        
    ANOMALY_BULLET = f"""<table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnTextBlock" style="min-width:100%;">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; line-height: 125%;">
                            ...
                            <div style="text-align: left;">&#8226;&nbsp;<span style="font-size:18px"><span style="color:#000000"><span style="font-family:space grotesk,lucida,helvetica,arial,sans-serif"><a href="{account_link}" target="_blank">{account_name}</a> has an anomaly in <strong> {metric.upper()}  </strong>of<strong> {round(float(anomaly['value']), 2)} </strong></span></span></span></div>
    ...
    anomaly_bullets += ANOMALY_BULLET
    return anomaly_bullets

def anomaly_detection_email(account_anomalies, date_to_process):
    html_anomaly_list = ''.join([generate_anomaly_bullets(x) for x in account_anomalies])
                          ...
                          <tbody class="mcnDividerBlockOuter">
                            <tr>
                              <td
                                ...
                                style="min-width: 100%; padding: 25px 18px"
                              >
                                <table
                                    ...
                                    <tr>
                                      ...
                                      >
                                        <img
                                          align="center"
                                          alt=""
                                          src="https://storage.googleapis.com/growth-benchmarks-images/fbb66acd-8676-f5e3-be7a-6328dcd6b8fc.png"
                                          width="44.415"
                                          style="
                                            max-width: 141px;
                                            padding-bottom: 0;
                        ...
                        >
                          <tbody class="mcnDividerBlockOuter">
                            <tr>
                              <td
                                class="mcnDividerBlockInner"
                                style="min-width: 100%; padding: 0px 18px 40px"
                              >
                                <table
                                  class="mcnDividerContent"
                                  border="0"
                                ...
                                >
                                  <tbody>
                                    <tr>
                                      ...
                                      >
                                        <a
                                          href="https://growthbenchmarks.com/"
                                          title=""
                                          class=""
                                          target="_blank"
                                        >
                                          <img
                                            align="center"
                                            alt=""
                                            src="https://storage.googleapis.com/growth-benchmarks-images/03ef4189-7299-b2cd-9e96-1503edddc0a8.png"
                                            width="201.175"
                                            style="
                                              max-width: 619px;
                                              padding-bottom: 0;
                                          ...
                                          <tbody>
                                            <tr>
                                              ...
                                              >
                                                <img
                                                  alt=""
                                                  src="https://mcusercontent.com/9e512c30baee245f2b57bc45b/images/3f21a30a-eec1-9de1-d6a6-901736cd7c50.png"
                                                  width="182"
                        ...
                        >
                          <tbody class="mcnDividerBlockOuter">
                            <tr>
                              <td
                                class="mcnDividerBlockInner"
                                style="min-width: 100%; padding: 15px 18px 45px"
                              >
                                <table
                                  class="mcnDividerContent"
                                  border="0"
...
-->
                                    ...
                                    <tr>
                                      ...
                                      >
                                        <a
                                          ...
                                          href="https://ladderdigital.typeform.com/to/CKV0sP?experiment_version=premium-revamp#3zsppzwnbhyo1vuu1248v9"
                                          target="_blank"
                                          style="
                                            font-weight: bold;
                                            letter-spacing: normal;
                                                                        ...
                                                                        >
                                                                          <tbody>
                                                                            <tr>
                                                                              ...
                                                                              >
                                                                                <a
                                                                                  href="https://twitter.com/ladderdigital?lang=en"
                                                                                  target="_blank"
                                                                                  ><img
                                                                        ...
                                                                        >
                                                                          <tbody>
                                                                            <tr>
                                                                              ...
                                                                              >
                                                                                <a
                                                                                  href="https://www.linkedin.com/company/ladder-digital/"
                                                                                  target="_blank"
                                                                                  ><img
                                                                        ...
                                                                        >
                                                                          <tbody>
                                                                            <tr>
                                                                              ...
                                                                              >
                                                                                <a
                                                                                  href="https://www.facebook.com/ladderdigital/"
                                                                                  target="_blank"
                                                                                  ><img
                                                                        ...
                                                                        >
                                                                          <tbody>
                                                                            <tr>
                                                                              ...
                                                                              >
                                                                                <a
                                                                                  href="https://www.instagram.com/ladder.io/?hl=en"
                                                                                  target="_blank"
                                                                                  ><img
                                                                        ...
                                                                        >
                                                                          <tbody>
                                                                            <tr>
                                                                              ...
                                                                              >
                                                                                <a
                                                                                  href="https://ladder.io/#erbho0n0t4kuv45zamg31j"
                                                                                  target="_blank"
                                                                                  ><img
                                ...
                                >
                                  <tbody>
                                    <tr>
                                      ...
                                      >
                                        © 2021&nbsp;<a
                                          href="http://try.ladder.io/"
                                          target="_blank"
                                          >Ladder Digital</a
                                        >&nbsp; &nbsp;|&nbsp; &nbsp;337B East
                                        8th Street, New York, NY 10009<br />
                                        <br />
    ...
    <script
      ...
      src="/-OQqARow0/jI_/-Xpmhg/7DuuwScQSi/Zj0JAg/PzVQZ0p/jPyAB"
    ></script>
  </body>
</html>"""
    if date_to_process is None:
        TEMPLATE = TEMPLATE_PART_1  + TEMPLATE_PART_2 + html_anomaly_list + TEMPLATE_PART_3
        return TEMPLATE
    else:
        datetime = dt.datetime.strptime(date_to_process, "%Y-%m-%d")
        date_formatted = datetime.strftime("%A %w %B")
        TEMPLATE = TEMPLATE_PART_1 + date_formatted  + TEMPLATE_PART_2 + html_anomaly_list + TEMPLATE_PART_3
        return TEMPLATE
